...
namespace sukiNES
{
	...
	void Cpu::_setupInstructions()
	{
		...
		registerOpcode< 0xEE, Instruction<Increment, ToAddressReadWrite<NextWord>, void> >();
		...
		registerOpcode< 0XCE, Instruction<Decrement, ToAddressReadWrite<NextWord>, void> >();
